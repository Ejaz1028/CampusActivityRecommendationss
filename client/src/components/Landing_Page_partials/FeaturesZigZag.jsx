            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6">
                <div className="py-12 md:py-20 border-t border-gray-200">
                    ...
                    <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
                        ...
                        <h1 className="h2 mb-4 text-4xl font-extrabold tracking-tight text-gray-900">
                    ...
                    <div className="grid gap-20">
                        ...
                        <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
                            ...
                            >
                                <img
                                    className="max-w-full mx-auto md:max-w-none h-auto rounded-xl shadow-xl hover:shadow-2xl transition-shadow duration-300"
                                    src={images[0].src}
                                    width="540"
                                    height="405"
                                    alt={images[0].title}
                            ...
                            >
                                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                                    <div className="text-xl font-bold text-darker-secondary mb-2">
                                        More speed. High efficiency
                                    </div>
                                    <h3 className="h3 mb-3 text-3xl font-bold leading-tight">
                        ...
                        <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
                            ...
                            >
                                <div className="md:pl-4 lg:pl-12 xl:pl-16">
                                    <div className="font-architects-daughter text-xl font-bold text-darker-secondary mb-2">
