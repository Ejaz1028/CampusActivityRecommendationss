...
export default function payment() {
    ...
    useEffect(() => {
        ...
        ws.onmessage = (event) => {
            ...
            if (message.type === 'event_notification') {
                alert(`Event Reminder: ${message.event.name} is happening on ${message.event.date}`);
            }
        };
        return () => {
            ws.close();
    ...
    const handlePayment = async () => {
        ...
        const token = {
            ...
            shipping_address_country: "Test Country",
        ...
        <div className="pt-20 lg:pt-8">
            ...
            <div className="flex flex-col m-6 ">
                ...
                <div className="m-6 flex flex-col ">
                    ...
                    <button
                        className="flex justify-center w-max bg-blue-500 text-white px-4 py-2 rounded"
